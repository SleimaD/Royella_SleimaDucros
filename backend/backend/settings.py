...
DATABASES = {
    'default': dj_database_url.config(default=' mysql://sn60nzlgnaiovkjm:yf7407wpukearrfb@xq7t6tasopo9xxbs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/mwja6pjyuxiomu5r')
}